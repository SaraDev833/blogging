  ...
  return (
    <>
      <form className="py-5 sm:pt-16 px-4 sm:pl-8" onSubmit={onSubmitHandler}>
        ...
        <input onChange={onChangeHandler} name="title" value={data.title} className="w-auto sm:w-[400px] px-4 py-3 outline-none border-2 border-black ring-0 placeholder:text-slate-400 mb-6" placeholder="blog title" />
        <p className="text-xl font-medium mb-4">Blog Description</p>
        <textarea onChange={onChangeHandler} name="description" value={data.value} className="w-auto sm:w-[400px] px-4 py-3 outline-none border-2 border-black ring-0 placeholder:text-slate-400 mb-6 " placeholder="description"  ></textarea>
